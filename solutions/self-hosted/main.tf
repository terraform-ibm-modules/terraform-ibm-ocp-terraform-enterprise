...
module "tfe" {
  ...
  tfe_custom_hostname                     = var.tfe_custom_hostname
  ...
  create_tfe_custom_hostname_on_cis       = var.create_tfe_custom_hostname_on_cis
  tfe_custom_domain_existing_secret_crn   = var.tfe_custom_domain_existing_secret_crn
